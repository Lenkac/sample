  ...
  linesData: [
    {
      ...
      coords: [[470, 890], [100, 890], [100, 780]]
    },
    {
      remark: "WEB服务器-->左边数起第3个负载均衡",
      coords: [[510, 890], [620, 890], [620, 780]]
    },
    {
      remark: "WEB服务器-->左边数起第4个负载均衡",
      coords: [[510, 890], [840, 890], [840, 780]]
    },
    {
      remark: "左边数起第1个负载均衡-->查验网站微信公众号政务网站1",
      coords: [[100, 723], [50, 580]]
    },
    {
      remark: "左边数起第1个负载均衡-->查验网站微信公众号政务网站2",
      coords: [[100, 723], [150, 580]]
    },
    {
      remark: "左边数起第2个负载均衡-->电子票制作及存储中心1",
      coords: [[350, 723], [300, 580]],
      lineStyle: {
        normal: {
          color: "#DC143C"
        }
    ...
    },
    {
      ...
      coords: [[630, 723], [570, 580]]
    },
    {
      remark: "左边数起第3个负载均衡-->票据服务器2",
      coords: [[630, 723], [670, 580]]
    },
    {
      remark: "左边数起第4个负载均衡-->电子制票及存储中心1",
      coords: [[850, 723], [800, 580]]
    },
    {
      remark: "左边数起第4个负载均衡-->电子制票及存储中心2",
      coords: [[850, 723], [900, 580]]
    },
    {
      remark: "查验网站-->Inceptor1",
      coords: [[100, 450], [100, 300], [160, 300]]
    },
    {
      remark: "电子票制作及存储中心-->Inceptor2",
      coords: [[350, 450], [350, 300], [280, 300]]
    },
    {
      remark: "票据服务器-->票据Oracle数据库服务器",
      coords: [[620, 450], [620, 300], [690, 300]]
    },
    {
      remark: "电子制票及储存中心-->票据Oracle数据库服务器",
      coords: [[850, 450], [850, 300], [810, 300]]
    }
  ]
};
for (var j = 0; j < nodes.length; j++) {
  ...
  var node = {
    ...
    symbolSize: 50,
    alarm: nodes[j].alarm,
    symbol: "@/assets/images/"+nodes[j].img,
    itemStyle: {
      normal: {
        color: "#12b5d0"
      }
